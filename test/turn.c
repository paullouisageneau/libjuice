...
int test_turn_tcp_fail(void) {
	...
	//   With fix:    the failed TCP connection state is detected on the next
	//                bookkeeping tick; the relay entry is immediately marked
	//                FAILED and agent_update_gathering_done() fires within ~2 s.
	//
